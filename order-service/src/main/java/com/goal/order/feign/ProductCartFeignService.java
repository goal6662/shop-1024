...
public interface ProductCartFeignService {
    ...
    @PostMapping("api/${app.config.api.version}/cart/mq/add/{user_id}")
    Result addCartItems(@RequestBody List<CartItemDTO> cartItemDTOList, @PathVariable("user_id") Long userId);
